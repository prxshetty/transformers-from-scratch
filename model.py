...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, self_attention_block: MultiHeadAttentionBlock, cross_attention : MultiHeadAttentionBlock, feed_forward_block: FeedForwardBlock, dropout: float):
        super().__init__()
    ...
    def forward(self, x, encoder_output, src_mask, tgt_mask): #src mask is for encoder and tgt mask is for the decoder
